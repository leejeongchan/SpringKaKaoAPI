					...
					<div class="container">
						<div class="row">
							<div class="col-md-9 col-lg-8 mx-auto">
								...
								<a
									class="btn btn-lg btn-primary btn-block btn-login text-uppercase font-weight-bold mb-2"
									href="/user/register">Sign Up</a> <a
									href="https://kauth.kakao.com/oauth/authorize?client_id=699e22769b9f3789d4764b8d68226a98&redirect_uri=http://localhost:8080/user/kakaologin&response_type=code">
